...
$(function(){
    $.ajax({
        type : 'get',
        url : eyou_basefile + "?m=admin&c=Uploadimgnew&a=ajax_get_treedir&lang=" + __lang__,
...
$(function(){
    ...
    $(".layui-btn-yes").click(function() {
        ...
        if (callback != "undefined") {
            ...
            $.ajax({
                type:'POST',
                url:eyou_basefile + "?m=admin&c=Uploadimgnew&a=update_pic&lang=" + __lang__,
...
function remote_to_imglocal() {
    ...
    $.ajax({
        type: 'POST',
        url : eyou_basefile + "?m=admin&c=Uploadimgnew&a=ajax_remote_to_imglocal&lang=" + __lang__,
...
function syn_old_imgdata(is_estop)
{
    ...
    var index = layer.open({
        ...
        fix: false,
        maxmin: false,
        content: eyou_basefile + "?m=admin&c=Uploadimgnew&a=site&lang=" + __lang__,
        end: function(){
...
function addcate(obj) {
    layer.prompt({
        ...
        $.ajax({
            type: 'post',
            url : eyou_basefile + "?m=admin&c=Uploadimgnew&a=Addtype&lang=" + __lang__,
...
function editcate(obj, type_id) {
    layer.prompt({
        ...
        $.ajax({
            type: 'post',
            url : eyou_basefile + "?m=admin&c=Uploadimgnew&a=EditType&lang=" + __lang__,
...
function delcate(obj, type_id) {
    layer.confirm('此操作不可恢复，确定删除？', {
        ...
        $.ajax({
            type: 'post',
            url : eyou_basefile + "?m=admin&c=Uploadimgnew&a=DelType&lang=" + __lang__,
