...
function stars(r) {
	...
	if (PFbai > 0) {
		...
		//$("#fenshu").animate({'width': parseInt(PFbai) + "%"});分数高度
	...
	$("ul.rating li").each(function(i) {
		...
		$(this).click(function () {
				if (hadpingfen > 0) {
					...
					$.getJSON(ROOT_PATH+'/index.php/ajax/score?mid='+$('#rating').attr('data-mid')+'&id='+$('#rating').attr('data-id')+'&score='+($(this).attr('val')*2), function (r) {
